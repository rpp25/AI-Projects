...
def train(traingroup):
    ...
    return prob_spam, prob_nonspam

def test(testgroup, prob_spam, prob_nonspam):
    is_spam = []
    not_spam = []
    ...
    return len(is_spam), len(not_spam)
...
if __name__ == '__main__':
    ...
    for i in range(0,5):
        ...
        pspam, pnonspam = train(traingroup)
        # for x in feature_training_data:
        test_spam, test_nonspam = test(testgroup,pspam,pnonspam)

        # positive = spam

        # print(len(results_false_positive))
        # print(test_nonspam)
        fp = len(results_false_positive)/test_nonspam
        # negative = non-spam
        fn = len(results_false_negative)/test_spam
